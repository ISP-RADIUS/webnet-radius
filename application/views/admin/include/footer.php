        ...
        <script src="<?php echo base_url(); ?>scripts/vendor/jquery-color/jquery.color.js"></script>
        ...
        <script src="<?php echo base_url(); ?>scripts/vendor/jasny-bootstrap/dist/js/jasny-bootstrap.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>scripts/vendor/dropzone/dist/min/dropzone.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>scripts/vendor/jquery-flot/jquery.flot.time.js"></script>
        <script src="<?php echo base_url(); ?>scripts/vendor/jquery-flot/jquery.flot.navigate.js"></script>
        ...
        <script src="<?php echo base_url(); ?>scripts/vendor/nestable/jquery.nestable.js"></script>
